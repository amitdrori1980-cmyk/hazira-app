                  ...
                  return (
                    <div key={idx} className={`flex items-center gap-3 px-4 py-2.5 border-b border-gray-50 last:border-0 flex-row-reverse ${st.bg} transition-colors`}>
                      ...
                      <div className="relative">
                        ...
                        {isPickerOpen && (
                          <div className="absolute right-0 bottom-8 z-[9999] bg-white border border-gray-200 rounded-xl shadow-xl p-2 flex flex-col gap-1 w-[150px]" style={{boxShadow:"0 8px 32px rgba(0,0,0,0.18)"}}>
                            {STATUSES.map(s => (
