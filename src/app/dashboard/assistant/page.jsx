...
export default function SearchPage() {
    ...
    return (
      <div className="mb-4">
        <div className="flex items-center gap-2 mb-2 flex-row-reverse justify-end">
          <i className={`ti ${cat.icon} text-[#E0197D]`} style={{fontSize:13}}/>
  ...
  return (
    <div className="max-w-2xl">
      {/* Search box */}
      <div className="flex items-center gap-3 bg-white border-2 border-[#E0197D] rounded-xl px-4 py-3 mb-4">
        <i className="ti ti-search text-[#E0197D]" style={{fontSize:18}}/>
        <input
          value={query}
        ...
        <div className="flex gap-2 mb-4 flex-wrap justify-end">
          {tabs.map(t => (
            <button key={t.id} onClick={()=>setActiveTab(t.id)}
              className={`text-[12px] px-3 py-1.5 rounded-full border transition-colors ${activeTab===t.id?'bg-[#E0197D] text-white border-[#E0197D]':'border-gray-200 text-gray-600 hover:border-[#E0197D]'}`}>
        ...
        <>
          ...
          <ResultSection id="crew" items={results.crew} renderItem={c => (
            <div key={c.id}
              ...
              <div className="w-8 h-8 rounded-full bg-[#FCE4F3] text-[#E0197D] text-[11px] font-bold flex items-center justify-center flex-shrink-0">
            ...
            <div key={s.id}
              ...
              <div className="flex-1 text-right">
                ...
                {s.location && <div className="text-[11px] text-gray-400 flex items-center gap-1 justify-end">
                  ...
                  <i className="ti ti-map-pin text-[#E0197D]" style={{fontSize:10}}/>
                </div>}
              </div>
