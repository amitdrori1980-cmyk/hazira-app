        ...
        <>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-4 mb-3">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-[11px] bg-[#FFE6F5] text-[#CC0090] px-2 py-0.5 rounded-full">{open.length}</span>
            </div>
              ...
              <div key={t.id} className="border-b border-gray-50 last:border-0">
                {editing === t.id ? (
                  <div className="py-2 flex flex-col gap-2">
                    ...
                    <div className="flex gap-2">
                      <button onClick={() => saveEdit(t.id)} className="flex-1 bg-[#FF3EB5] text-white text-sm py-1.5 rounded-lg">שמור</button>
                  ...
                  <div className="flex items-center gap-2.5 py-2 flex-row-reverse group">
                    <input type="checkbox" checked={false} onChange={() => toggleDone(t)}
                      className="w-4 h-4 flex-shrink-0" style={{accentColor:'#FF3EB5'}}/>
                    ...
                    <button onClick={() => startEdit(t)}
                      className="text-gray-200 hover:text-[#FF3EB5] opacity-0 group-hover:opacity-100 transition-all">
