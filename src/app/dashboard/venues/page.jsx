      ...
      {viewing && (
        <div className="fixed inset-0 z-50 bg-black/70 flex flex-col">
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-5 bg-gray-50 md:hidden px-6 text-center">
            <div className="w-16 h-16 bg-[#FCE4F3] rounded-2xl flex items-center justify-center">
              <i className="ti ti-file-type-pdf text-[#E0197D]" style={{fontSize:32}}/>
            </div>
            <div>
            ...
            <a href={viewing.url} target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-[14px] bg-[#E0197D] text-white px-6 py-3 rounded-xl font-medium active:bg-[#A0106A]">
