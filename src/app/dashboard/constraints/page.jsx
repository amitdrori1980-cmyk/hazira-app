          ...
          {Array.from({length:daysInMonth}).map((_,i)=>{
            ...
            return (
              <div key={d} onClick={()=>setSelectedDay(ds)}
                ...
                {present.length>0 && (
                  <div className="hidden md:block text-[12px] px-1 py-0.5 rounded mb-0.5 truncate bg-[#FEF9C3] text-[#713f12]">
          ...
          {weekCells.map((c, ci) => {
            ...
            return (
              <div key={ci} onClick={()=>setSelectedDay(c.ds)}
                ...
                {present.length>0 && (
                  <div className="text-[10px] md:text-[13px] px-1.5 py-1 rounded mb-1 bg-[#FEF9C3] text-[#713f12] leading-snug">
                ...
                <div>
                  ...
                  {present.length > 0 ? (
                    <div className="flex flex-wrap gap-1.5">
                      {present.map(c => <Chip key={c.id} c={c} tone="bg-[#FEF9C3] text-[#713f12]" />)}
                    </div>
